...
#DBStyleImageButton3 { position:absolute;left:16;top:180;width:146;z-index:2 }
#DBStyleImageButton4 { position:absolute;left:15;top:234;width:146;z-index:3 }
#EndOfPage { position:absolute;left:0;top:280;width:0 }
</STYLE>
...
<DIV ID="DBStyleImage1"><IMG ID="Image1" Name="Image1" Class="Normal" SRC="media/personnhead.jpg" Width="638" Height="134" Border="0">
</DIV>
...
<A HREF="Personnel.asp"  onMouseOver="_B__onMouseOver( 1);"  onMouseOut="_B__onMouseOut( 1);">
<IMG ID="ImageButton4" Name="ImageButton4" Class="Normal" SRC="media/personnelhi.jpg" Width="146" Height="36" Border="0"></A>
</DIV>
</DIV><SCRIPT>__calcSectionHeight(Section0, 0)</SCRIPT>
<SCRIPT SRC="media/PersonnelInline.js"></SCRIPT>

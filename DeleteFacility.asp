...
SQL = "Select * from tblFacilities where FacilityID="&request("deletefacility")
...
message="A facility, "&name&" , has been deleted from the database."
%>
...
#DBStyleImageButton1 { position:absolute;left:16;top:180;width:146;z-index:2 }
#Text1 { position:absolute;left:194;top:184;width:500;z-index:1 }
#EndOfPage { position:absolute;left:0;top:226;width:0 }
</STYLE>
...
<SCRIPT SRC="media/DeleteFacilityInline.js"></SCRIPT>

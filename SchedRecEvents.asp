...
SQL = "Select * from tblEvents WHERE Type='"&"R"&"'"
...
Response.Write"<table border='1' width='100%'>"
  ...
  Response.Write"<tr>"
    ...
    Response.Write"<td width='5%'><strong>Date</strong></td>"
	Response.Write"<td width='30%'><strong>Location</strong></td>"
	Response.Write"<td width='15%'><strong>Participant Group 1</strong></td>"
    Response.Write"<td width='15%'><strong>Participant Group 2</strong></td>"
	Response.Write" <td width='15%'><strong>Participant Group 3</strong></td>"
  Response.Write"</tr>"

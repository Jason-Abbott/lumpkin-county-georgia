...
SQL = "Select * from tblEvents WHERE Date = #"&CDate(eventdate)&"# AND Location ="&location

rs.open SQL,conn, 1,2

If rs.EOF then
message= "There are no events scheduled for this event and location."
...
#Text1 { position:absolute;left:182;top:147;width:557;z-index:1 }
#DBStyleImageButton4 { position:absolute;left:16;top:175;width:146;z-index:2 }
#DBStyleImageButton5 { position:absolute;left:16;top:231;width:146;z-index:3 }
#EndOfPage { position:absolute;left:0;top:277;width:0 }
</STYLE>
...
<SCRIPT SRC="media/DateLocationInline.js"></SCRIPT>

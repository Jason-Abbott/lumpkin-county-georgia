...
var ImageButton4 = new makeButton('media/mainhome.jpg,media/mainhilite.jpg',
	'StaffHome.asp','ImageButton4','EditEvent','ImageButton4',nullFunc,nullFunc,nullFunc,nullFunc,nullFunc);
BTNArray[ 0] = ImageButton4;
var ImageButton1 = new makeButton('media/searchevents.jpg,media/searcheventshi.jpg',
	'SearchEvents.asp','ImageButton1','EditEvent','ImageButton1',nullFunc,nullFunc,nullFunc,nullFunc,nullFunc);
BTNArray[ 1] = ImageButton1;
var ImageButton6 = new makeButton('media/newevent.jpg,media/neweventhi.jpg',
	'NewEvent.asp','ImageButton6','EditEvent','ImageButton6',nullFunc,nullFunc,nullFunc,nullFunc,nullFunc);
